...
for n in n_clusters:
    ...
    np.savetxt('logs/' + setting_name + "/if.preds_" + ".log", pred_real_copod, delimiter=',', fmt='%s')
    ...
    # Saving predicted and real classes
    np.savetxt('logs/' + setting_name + "/if.preds.log", pred_real_copod, delimiter=',', fmt='%s')

    # Saving metrics
    np.savetxt('logs/' + setting_name + "/if.metrics.weighted.log", metrics_copod_weighted, delimiter=',', fmt='%s')
    np.savetxt('logs/' + setting_name + "/if.metrics.macro.log", metrics_copod_macro, delimiter=',', fmt='%s')
    np.savetxt('logs/' + setting_name + "/if.metrics.micro.log", metrics_copod_micro, delimiter=',', fmt='%s')
